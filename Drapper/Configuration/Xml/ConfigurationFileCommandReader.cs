...
namespace Drapper.Configuration.Xml
{
    ...
    public class ConfigurationFileCommandReader : ICommandReader
    {
        ...
        private NamespaceSettingElement GetNamespaceSettingElement(
            DrapperConfigurationSection section,
            Type type)
        {
        ...
        private TypeSettingElement GetTypeSettingElement(
            NamespaceSettingElement namespaceSetting,
            Type type)
        {
        ...
        private CommandSettingElement GetCommandSetting(
            TypeSettingElement typeSetting,
            string key)
        {
        ...
        private class ErrorMessages
        {
            ...
            internal const string UnknownType =
                "No type entry could be found for {0}.";

            internal const string NoCommandSetting =
                "No CommandSetting could be found for {0}.{1}";

            internal const string NoNamespaceEntry =
                "The namespace {0} entry could not be found.";

            internal const string NoSectionDefinition =
                "No configuration section could be found for Drapper.";
