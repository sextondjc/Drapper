...
namespace Drapper.MySql.Integration.Tests
{
    ...
    public class MySqlQueryFixture : QueryFixture
    {
        public MySqlQueryFixture() : base(CommanderHelper.CreateCommander<Query>(() => SqlClientFactory.Instance, "Drapper.Databases.Tests.MySql.json"))
        {
